                ...
                <div className="row justify-content-center">
                    <div className="col-xl-10">
                        <div className="user-agreement-content">
                            ...
                            <p className="mb-20"><strong>Son Güncelleme:</strong> 16 Aralık 2024</p>
                            ...
                            <div className="agreement-section mb-40">
                                ...
                                <h4>7.2. İade</h4>
                                <p>Satın aldığınız kurstan memnun kalmazsanız, satın alma tarihinden itibaren 14 gün içinde ve kursun %20'sinden azını tamamlamış olmanız koşuluyla tam iade talep edebilirsiniz. İade talepleri info@verininmutfagi.com adresine e-posta ile yapılmalıdır.</p>
                            </div>
