...
const faq_data: DataType[] = [
   {
      id: 1,
      page: "home_1",
      question: "Verinin Mutfağı size ne sunuyor?",
      answer: "Verinin Mutfağı, alanında uzman eğitmenlerimizle birlikte en kaliteli online eğitim deneyimini sunar. Binlerce kurs arasından seçim yapabilir, kendi hızınızda öğrenebilir ve sertifikalar kazanabilirsiniz.",
   },
   {
      id: 2,
      page: "home_1",
